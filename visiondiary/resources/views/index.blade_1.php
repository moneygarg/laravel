    ...
    <div class="container clearfix">
      <div class=" col-lg-12 col-md-12 col-sm-12 clearfix">
        ...
        <nav class="portfolio-filter clearfix">
          <ul>
            <li><a href="gallery-portfolio.html#" class="dmbutton2" data-filter="*">All Works (8)</a></li>
            <li><a href="gallery-portfolio.html#" class="dmbutton2" data-filter=".mockups">Mockups</a></li>
            <li><a href="gallery-portfolio.html#" class="dmbutton2" data-filter=".graphic-design">Graphics</a></li>
            <li><a href="gallery-portfolio.html#" class="dmbutton2" data-filter=".web-design">Web Projects</a></li>
          </ul>
        </nav>
        ...
        <div class="portfolio-centered">
          <div class="recentitems portfolio">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 graphic-design mockups">
              <div class="he-wrap tpl6 market-item">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 web-design mockups">
              <div class="he-wrap tpl6 market-item">

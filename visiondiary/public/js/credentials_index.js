...
$().ready(function(){
    ...
    $("#filter_form_reset").click(function(event){
       stopevent(event);
        ...
        $("#filter_id_project_type").val("");
        $("#filter_id_project_type").trigger("chosen:updated");
        
        $("#filter_id_environment_type").val("");
        $("#filter_id_environment_type").trigger("chosen:updated");
...
//        $(document).on("click",".edit",function(){editactions});
...
function eventactions()
{
    ...
    $('#listTable').on('click', '.copy', function() {
       copytoclipboardactions(event);
    });
}

function copytoclipboardactions(event)
{
    value = $(event.target).attr("cp");
